...
// console.log("Conteudo do Menu ", document.getElementsByTagName("footer")[0].innerText)
...
window.onload = function startContinuousArtyom() {
    ...
    // artyom.addCommands([
    //     {
    //         indexes: ["Diga o Menu", "Ver Menu", "Fale o Menu"],
    //         action: function (i) {
    //             lerMenu()
    //         }
    //     }
    ...
    // artyom.addCommands([
    //     {
    //         indexes: ["Diga o rodape", "Ver Menu", "Fale o Menu"],
    //         action: function (i) {
    //             lerMenu()
    //         }
    //     }
    ...
    // artyom.on(['ir para *'], true).then(function (i, wildcard) {
    //     alert("Tetoo ", wildcard)
    //     todosLinks.forEach(element => {
    //         if (wildcard == element.innerText) {
    //             // ("login.html", "_self")
    //             window.open(element.href, "_sef");
    //         }
    //     });
